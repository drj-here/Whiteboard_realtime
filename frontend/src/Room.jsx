...
export default function Room({userNum,socket,setUsers,setUserNum}) {
    ...
    <div className='container-fluid'>
     <div className='row'>
        <h1 className='display-5 pt-4 pb-3 text-center'>
            React Drawing App- Users online:{userNum}
        </h1>
     </div>
     <div className='row justify-content-center align-items-center text-center py-2'>
        ...
        <div className='col-md-3'>
            <div className='form-check form-check-inline'>
                ...
                />
                <label 
                className='form-check-label' htmlFor='pencil'>
                    Pencil 
                </label>
            </div>
            <div className='form-check form-check-inline'>
            ...
            <div className='form-check form-check-inline'>
                ...
                />
                <label
                className='form-check-label' htmlFor='rect'>
                    Rectangle 
                </label>
            </div>
        </div>
